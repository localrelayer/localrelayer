    ...
    <div className="faq">
      <article className="wrapper">
        <div className="qa-container">
          <Question>What is Local Relayer?</Question>
          <p className="a">
            Local Relayer is one of the first Ethereum based decentralized exchanges to support
            real-time trading and high transaction throughput.
            Local Relayer supports limit orders, gas-free cancels, and the ability to fill many
            trades at once. Due to our matching engine we eliminated front-running problem too.
          </p>
        </div>
        <div className="qa-container">
          <Question>How to use Local Relayer?</Question>
          <p className="a">
            You need to get
            ...
            to sign orders on Local Relayer. Here is our official guide
            on how to create your first order.
          </p>
        </div>
        <div className="qa-container">
          <Question>How does Local Relayer work?</Question>
          <p className="a">
            Local Relayer utilizes 0x protocol and our own matching engine. The 0x protocol is responsible for trustlessly storing all assets and
        ...
        <div className="qa-container">
          <Question>What are the fees to trade on Local Relayer?</Question>
          <p className="a">
            While in beta, only gas fee is taken (~$1)
            Local Relayer will charge 0.3% fee for every successful transaction after beta.
        ...
        <div className="qa-container">
          ...
          <p className="a">
            ...
            to process the transaction. Each trade on Local Relayer cost ~200k-300k gas. But this amount is distributed between
        ...
        <div className="qa-container">
          ...
          <p className="a">
            ...
            For order matching Local Relayer pays the gas fee to the network and deducts this fee from the user’s
            transaction.
          </p>
        </div>
        <div className="qa-container">
          <Question>Why are there minimum trade orders on Local Relayer?</Question>
          <p className="a">
            Local Relayer has a minimum order of 0.005 ETH.
          </p>
          <p className="a">
        ...
        <div className="qa-container">
          <Question>Are my funds safe on Local Relayer?</Question>
          <p className="a">
